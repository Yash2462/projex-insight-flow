    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-hero p-4">
      <Card className="w-full max-w-md shadow-elegant border-0 rounded-[2rem] overflow-hidden">
        ...
        <CardHeader className="space-y-1 text-center pt-8">
          ...
          <CardTitle className="text-3xl font-black tracking-tight animate-in fade-in slide-in-from-top-4 duration-700 delay-100 fill-mode-backwards">Welcome back</CardTitle>
        ...
        <CardContent className="p-8 pt-4">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400 fill-mode-backwards">
                <FormField
                  control={form.control}
                  name="password"
                  render={({ field }) => (
                      ...
                      <FormControl>
                        <div className="relative group">
                          ...
                          <Input
                            ...
                            className="pl-11 pr-11 h-11 glass-input rounded-xl font-bold"
                            {...field}
                          />
                          <Button
                            type="button"
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-backwards">
                <Button
                  type="submit"
                  className="w-full h-12 text-sm font-black rounded-xl transition-all active:scale-[0.98] shadow-glow"
                  variant="hero"
                  disabled={isLoading}
                >
                  {isLoading ? (
              ...
              <div className="relative py-2 animate-in fade-in duration-700 delay-600 fill-mode-backwards">
          ...
          <div className="mt-8 text-center text-xs animate-in fade-in duration-700 delay-800 fill-mode-backwards">
