...
const KanbanBoard = ({ 
  ...
  const onDragEnd = (result: DropResult) => {
    ...
    if (sourceColId === destColId) {
      ...
      const updatedMovedIssue: Issue = { ...movedIssue, status: destColId };
      destIssues.splice(destination.index, 0, updatedMovedIssue);
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="overflow-x-auto overflow-y-hidden pb-6 -mx-6 px-6 no-scrollbar relative">
